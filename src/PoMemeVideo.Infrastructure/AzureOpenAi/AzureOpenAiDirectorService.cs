...
public sealed class AzureOpenAiDirectorService : IDirectorService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation(
            "Session {SessionId}: Azure director start. VisionLabels={VisionLabelCount}, Candidates={CandidateCount}, Endpoint={Endpoint}, Deployment={Deployment}, CancellationRequested={CancellationRequested}",
            sessionId,
            visionLabels.Length,
            topCandidates.Count,
            _endpoint,
